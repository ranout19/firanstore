    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3><?= $page == 'add' ? 'Tambah' : 'Edit' ?> Supplier</h3><a href="<?= site_url('supplier') ?>" style="padding: 10px 14px; position: absolute; right: 20px;" class="badge badge-yellow text-white"><i class="ik ik-chevron-left" style="font-weight: 1000; margin-left: -8px;"></i> Kembali</a>
            </div>
            <div class="card-body">
                <div class="row">
