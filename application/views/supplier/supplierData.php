...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header"><h3>Data Supplier</h3><a href="<?=site_url('supplier/add')?>" style="position: absolute; right: 20px; padding: 10px;" class="badge badge-blue text-white"><i class="ik ik-plus" style="font-weight: 1000;"></i> Tambah</a></div>
            <div class="card-body">
                		...
                		<tr>
                            ...
                            <td>
                                <div class="table-actions float-right">
                                    <a href="<?= site_url('supplier/edit/'.$data->supplier_id) ?>" class="btn btn-sm btn-warning" style="width: 33px; margin-left: 0px; background: #ffc800; border-color: #ffc800;"><i class="ik ik-edit text-white" style="position: absolute;right: 46px;"></i></a>
                                    <a href="<?= site_url('supplier/del/'.$data->supplier_id) ?>" class="hapus btn btn-sm btn-danger" style="width: 33px; margin-left: 0px;"><i class="ik ik-trash-2 text-white" style="position: absolute;right: 10px;"></i></a>
                                </div>
                            </td>
                        </tr>
                	<?php	}
