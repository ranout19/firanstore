                    ...
                    <div class="col-md-4 my-auto p-0">
                        <div class="card" style="margin-top: 70px;">
                            <div class="authentication-form mx-auto">
	                            <div class="logo-centered d-flex justify-content-md-center">
	                                <img src="<?=base_url()?>assets/firan.png" alt="" style="margin-bottom: -20px; width: 70px;">
	                            </div>
	                            <h3 class="text-center">Firan Store Indonesia</h3>
