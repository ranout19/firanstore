...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header"><h3>Data Stock In</h3><a href="<?=site_url('stock/in/add')?>" style="position: absolute; right: 20px; padding: 10px;" class="badge badge-blue text-white"><i class="ik ik-plus" style="font-weight: 1000;"></i> Tambah</a></div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions float-right">
                                    <a class="btn btn-sm btn-info" style="width: 33px; margin-left: 0px;" type="button" id="detailitem" data-toggle="modal" data-target="#modal-detail" data-barcode="<?=$data->barcode?>" data-name="<?=$data->itemname?>" data-qty="<?=$data->qty?>" data-detail="<?=$data->detail?>" data-suppliername="<?=$data->suppliername?>" data-date="<?=$data->date?>"><i class="ik ik-eye text-white" style="position: absolute;right: 47px;"></i></a>
                                    <a href="<?= site_url('stock/in/del/'.$data->stock_id.'/'.$data->item_id) ?>" class="hapus btn btn-sm btn-danger" style="width: 33px; margin-left: 0px;"><i class="ik ik-trash-2 text-white" style="position: absolute;right: 10px;"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php   }
