  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h3> Tambah Stock Masuk</h3><a href="<?= site_url('stock/in') ?>" style="padding: 10px 14px; position: absolute; right: 20px;" class="badge badge-yellow text-white"><i class="ik ik-chevron-left" style="font-weight: 1000; margin-left: -8px;"></i> Kembali</a>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-5 formdata">
            <form class="forms-sample" action="<?= site_url('stock/process') ?>" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" name="in_add" class="badge badge-green text-white mr-2" style="border: none; padding: 10px 14px;"><i class="ik ik-send" style="font-weight: 1000;"></i> Simpan</button>
