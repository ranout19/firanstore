<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header"><h3> Add Stock In</h3><a href="<?=site_url('stock/in')?>" style="padding: 10px 14px; position: absolute; right: 20px;" class="badge badge-yellow text-white"><i class="ik ik-chevron-left" style="font-weight: 1000; margin-left: -8px;"></i> Back</a></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-5 formdata">
                        <form class="forms-sample" action="<?= site_url('stock/process') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="text" name="tanggal" value="<?= date('d F Y') ?>" class="form-control datetimepicker-input" id="datepicker" readonly>
                          	</div>
                          	<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="detail" name="detail" placeholder="stock baru / tambahan / dll" required>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="in_add" class="badge badge-green text-white mr-2" style="border: none; padding: 10px 14px;"><i class="ik ik-send" style="font-weight: 1000;"></i> Save</button>
