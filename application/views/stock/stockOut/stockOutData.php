  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3>Data Stok Keluar</h3><a href="<?= site_url('stock/out/add') ?>" style="position: absolute; right: 20px; padding: 10px;" class="badge badge-blue text-white"><i class="ik ik-plus" style="font-weight: 1000;"></i> Tambah</a>
      </div>
      <div class="card-body">
        <table id="data_table" class="table table-hover w-100">
          <thead>
            <tr>
              ...
              <th class="nosort" style="border:none;">Nama Item</th>
              ...
              <tr>
                ...
                <td>
                  <div class="table-actions float-right">
                    <a class="btn btn-sm btn-info" style="display: inline-flex; padding: 8px;" type="button" id="detailitem" data-toggle="modal" data-target="#modal-detail" data-barcode="<?= $data->barcode ?>" data-name="<?= $data->itemname ?>" data-qty="<?= $data->qty ?>" data-detail="<?= $data->detail ?>" data-date="<?= $data->date ?>"><i class="ik ik-eye text-white" style="margin-top: -1px !important; margin-right: -1px !important;"></i></a>
                    <a href="<?= site_url('stock/out/del/' . $data->stock_id . '/' . $data->item_id) ?>" class="hapus btn btn-sm btn-danger" style="display: inline-flex; padding: 8px;"><i class="ik ik-trash-2 text-white" style="margin-top: -1px !important; margin-right: -1px !important;"></i></a>
                  </div>
                </td>
              </tr>
            <?php   }
