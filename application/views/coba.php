                                    ...
                                    <div class="notifications-wrap">
                                        <a href="#" class="media">
                                            ...
                                            <span class="media-body">
                                                ...
                                                <span class="media-content">Your have been Invited <?=base_url()?>assets.</span>
                                            </span>
                                        </a>
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                        ...
                                        <a href="#" class="media">
                                            ...
                                            <span class="media-body">
                                                ...
                                                <span class="media-content">Meeting with Nathan on Friday 8 AM <?=base_url()?>assets.</span>
                                            </span>
                                        </a>
                                    </div>
                ...
                <aside class="right-sidebar">
                    <div class="sidebar-chat" data-plugin="chat-sidebar">
                        <div class="sidebar-chat-info">
                            ...
                            <form class="mr-t-10">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Search for friends <?=base_url()?>assets."> 
                            ...
                            <div class="row">
                                <div class="col-md-4 ml-auto mr-auto">
                                    <div class="input-wrap">
                                        <input type="text" id="quick-search" class="form-control" placeholder="Search<?=base_url()?>assets." />
                                        <i class="ik ik-search"></i>
                                    </div>
                                </div>
                            </div>
