  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h3>Tambah User</h3><a href="<?= site_url('user') ?>" style="padding: 10px 14px; position: absolute; right: 20px;" class="badge badge-yellow text-white"><i class="ik ik-chevron-left" style="font-weight: 1000; margin-left: -8px;"></i> Kembali</a>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-5 formdata">
            <form class="forms-sample" action="" method="post">
              <div class="form-group">
                <label for="fullname" class="<?= form_error('fullname') ? 'labelerror' : null; ?>">Nama Lengkap</label>
              ...
              <div class="form-group">
                <label for="phone" class="<?= form_error('phone') ? 'labelerror' : null; ?>">Telepon</label>
              ...
              <div class="form-group">
                <label for="passwordconf" class="<?= form_error('passwordconf') ? 'labelerror' : null; ?>">Konfirmasi Password</label>
              ...
              <div class="form-group">
                <label class="custom-control custom-checkbox">
                  ...
                  <span class="custom-control-label">Lihat password</span>
                </label>
              </div>
              <button type="submit" name="add" class="badge badge-green text-white mr-2" style="border: none; padding: 10px 14px;"><i class="ik ik-send" style="font-weight: 1000;"></i> Simoan</button>
