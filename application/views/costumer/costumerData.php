  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3>Data Costumer</h3><a href="<?= site_url('costumer/add') ?>" style="position: absolute; right: 20px; padding: 10px;" class="badge badge-blue text-white"><i class="ik ik-plus" style="font-weight: 1000;"></i> Tambah</a>
      </div>
      <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  <div class="table-actions float-right">
                    <a href="<?= site_url('costumer/edit/' . $data->costumer_id) ?>" class="btn btn-sm btn-warning" style="display: inline-flex; padding: 8px; background: #ffc800; border-color: #ffc800;"><i class="ik ik-edit text-white" style="margin-right: -1px !important;margin-top: -1px !important;"></i></a>
                    <a href="<?= site_url('costumer/del/' . $data->costumer_id) ?>" class="hapus btn btn-sm btn-danger" style="display: inline-flex; padding: 8px;"><i class="ik ik-trash-2 text-white" style="margin-right: -1px !important;margin-top: -1px !important;"></i></a>
                  </div>
                </td>
              </tr>
            <?php  }
